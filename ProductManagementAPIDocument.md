...
The API is available at [`Swagger`](http://api.testek.online/api/v0/prod-man/swagger-ui.html#) <br/>
Alternative URL: [`Swagger`](http://api.testek.online/api/v0/prod-man/swagger-ui.html#)  (HTTP only!) <br/> 
